...
- Commit settle in ASR is monotonic forward: deferred readability and truth correction may move forward, but must not apply backward correction against a forward writer commit (ahead-of-target settle is treated as healthy, not a desync).
