...
- Cue-boundary bridge progression requires an actual bridge (`>=1` skipped skippable line). Same-line nudge/confirmation must not plain-advance to an adjacent speakable content line when no cue/meta line was skipped.
