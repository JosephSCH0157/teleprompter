...
- Same-line nudge/confirmation paths must apply a cue-boundary bridge: when `cursor+1` is cue-only, allow advancing to the first speakable line within `+3` before declaring same-line/noop.
