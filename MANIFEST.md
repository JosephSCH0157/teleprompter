...
- Add a stable interim nudge bridge: in live armed ASR after first commit, if interim transcript remains meaningfully stable for ~0.5-0.8s while matching current line at/above progressive floor, trigger the same one-line nudge path used by final confirmations.
