// ui/normTokens.js
// Runtime shim for normTokens: prefer window.normTokensImpl, else provide a legacy impl
(function(){
  function legacyNormTokens(text) {
    let t = String(text)
      .toLowerCase()
      .replace(/’/g, "'")
  ...
  try {
    if (window.normTokensImpl && typeof window.normTokensImpl === 'function') {
      window.normTokens = window.normTokensImpl;
    } else {
      window.normTokensImpl = legacyNormTokens;
      window.normTokens = legacyNormTokens;
    }
  } catch {}
})();
