...
let _onTranscript: ((t: string, isFinal: boolean) => void) | null = null;

export function currentMode() {
  return _mode;
}

export async function startASRorVAD(onTranscript: (t: string, isFinal: boolean) => void, preferASR = true) {
