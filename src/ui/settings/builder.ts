    ...
    <div class="settings-panels">
      ...
      <section class="settings-card asr anim-in" id="asrSettingsCard">
        ...
        <div class="settings-grid" style="gap:8px;grid-template-columns: repeat(auto-fit,minmax(160px,1fr));">
          ...
          <label>Language
            <input id="asrLang" type="text" placeholder="en-US" title="Language youíll speak during recording so ASR can interpret correctly.">
          </label>
  ...
  try {
    ...
    sec.innerHTML = `
      ...
      <div
        ...
        hidden
      >
        Click ‚??Start calibration‚?ù to begin. We‚??ll ask you to stay quiet, then speak in your normal voice.
      </div>
